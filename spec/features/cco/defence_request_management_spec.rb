...
RSpec.feature "call center operatives managing defence requests" do
  ...
  context "with any request" do
    ...
    scenario "can see the show page of the request" do
    ...
    scenario "can not edit expected time of arrival from the request show page" do
      visit defence_requests_path
      within ".accepted-defence-request" do
        click_link("Show")
      end
  ...
  context "with requests they are assigned to" do
    ...
    context "that have not yet been opened" do
      ...
      scenario "cannot edit the request" do
        visit root_path
      ...
      #TODO - make better
      scenario "can open the request" do
        visit root_path
        within "#defence_request_#{unopened_dr.id}" do
          click_button "Open"
        end
      ...
      #TODO - make better
      scenario "cannot mark the request as accepted" do
        visit root_path
    ...
    context "that have been opened by this cco" do
      ...
      scenario "can edit the solicitors details on the request" do
        visit root_path
      ...
      scenario "can add/edit the DSCC number on the request" do
        visit root_path
        within "#defence_request_#{opened_dr.id}" do
          click_link "Edit"
        end
      ...
      scenario "can mark the request as accepted from the request\'s edit page whilst adding a dscc number" do
        visit root_path
      ...
      scenario 'can not choose "Update and Accept" from the request\'s edit page without adding a dscc number' do
        visit root_path
      ...
      context 'that have a dscc number' do
        scenario 'can accept the request from the dashboard' do
      ...
      context 'that have the "duty" solicitor type' do
        ...
        scenario 'can not mark the request as accepted from the dashboard without solicitor detials' do
          visit root_path
        ...
        scenario 'can only mark the request as accepted from the edit page with solicitor details and dscc number' do
          visit root_path
  ...
  context "that have been marked as accepted" do
    ...
    scenario 'can edit the expected time of arrival on the request' do
      visit root_path
